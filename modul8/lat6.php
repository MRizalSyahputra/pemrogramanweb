...
<body>
    <?php
    function print_miring($kata, $italic = true) { //function untuk mencetak output menjadi miring
    echo $italic ? "<i>" .$kata. "</i>" : $kata;
    }
    function print_tebal($kata, $italic = true) { //function untuk mencetak output menjadi tebal
    echo $italic ? "<b>" .$kata. "</b>" : $kata;
    }
    function jumlah($a, $b) { //function untuk menjumlahkan variabel
    return ($a + $b); //mereturn hasil penjumlahan
    }
    function kali($a, $b) { //function untuk mengalikan variabel
    return ($a * $b);
    }
